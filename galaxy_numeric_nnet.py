...
batch_number, input_size, hidden_layer_size, output_size = 100, 2, 50, 1
...
class TwoLayerNet(nn.Module):
    ...
    def forward(self, X) -> list[float]: ## Forward must always be defined and it outlines the order the feedforward mechanism follows during the training of the neural network.
