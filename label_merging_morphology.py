...
def add_merging_morphology_classes(catalog, smooth_threshold=0.8, features_threshold=0.5, 
...
if __name__ == "__main__":
    ...
    matched_with_classes = add_merging_morphology_classes(matched_catalog) 
